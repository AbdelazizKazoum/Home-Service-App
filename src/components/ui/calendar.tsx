  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "text-muted-foreground w-full flex-1 rounded-md w-8 font-normal text-[0.8rem]",
        ...
        day_outside:
          "day-outside text-muted-foreground opacity-50  aria-selected:bg-primary/50 aria-selected:text-white aria-selected:opacity-30",
